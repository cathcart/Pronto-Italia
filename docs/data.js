(function () {
  ...
  const phrases = [
    ...
    ["food-menu-porcini", "food", "Funghi porcini", "Porcini mushrooms.", "porcini", "A prized mushroom often found with pasta, risotto, or meat."],
    ["food-menu-champignon", "food", "Champignon", "Button mushrooms.", "champignon", "Often used for common cultivated mushrooms."],
    ...
    ["food-menu-uovo", "food", "Uovo", "Egg.", "uovo", "Singular egg. The plural is uova."],
    ["food-menu-uova", "food", "Uova", "Eggs.", "uova", "Common in pasta dough, carbonara, frittata, desserts, and sauces."],
    ["food-menu-frittata", "food", "Frittata", "Italian omelette.", "frittata", "A clear sign that eggs are central to the dish."],
    ["food-menu-carbonara", "food", "Alla carbonara", "With egg, cheese, pepper, and cured pork.", "carbonara", "Carbonara sauce traditionally contains egg."],
    ...
    ["food-menu-fragole", "food", "Fragole", "Strawberries.", "fragole", "The singular is fragola."],
    ["food-menu-fragola", "food", "Alla fragola", "Strawberry-flavoured or with strawberry.", "fragola", "Common for gelato, desserts, yoghurt, and sauces."],
    ["food-menu-fragole-panna", "food", "Fragole con panna", "Strawberries with cream.", "con panna", "A simple dessert phrase that often appears in season."],
    ["food-menu-crostata-fragole", "food", "Crostata alle fragole", "Strawberry tart.", "alle fragole", "Crostata is a tart or jam tart style dessert."],
    ...
    ["food-menu-contains-eggs", "food", "Contiene uova?", "Does it contain eggs?", "contiene", "Useful for checking pasta, sauces, desserts, and fried coatings."],
    ["food-menu-egg-free", "food", "Senza uova", "Egg-free.", "senza", "Senza means without."],
  ...
  const scenarios = [
    ...
    },
    {
      ...
      phraseIds: ["food-menu-antipasti", "food-menu-primi", "food-menu-secondi", "food-menu-contorni", "food-menu-funghi", "food-menu-uova", "food-menu-alla-griglia", "food-menu-frutti-mare", "food-menu-pesce-giorno", "food-menu-fragole", "food-menu-tiramisu", "food-menu-coperto"],
      question: {
